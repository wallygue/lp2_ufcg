...
//		controller.cadastrarFornecedor("Dona In�s", "dines@gmail.com", "83 9999-5050");
//		controller.cadastrarFornecedor("Ron Weasley", "rweasley@splab.ufcg.edu.br", "83 99936-5050");
//
//		controller.adicionarProduto("Josenilda", "Mousse", "Mousse de Lim�o", "4,00");
//		controller.adicionarProduto("Dona In�s", "Tapioca simples", "Tapioca com manteiga", "3,00");
//		controller.adicionarProduto("Dona In�s", "Bolo", "Bolo de chocolate", "3,00");
//		controller.adicionarProduto("Ron Weasley", "Coxinha", "Coxinha de Frango", "2,00");
//		controller.adicionarProduto("Dona In�s", "Tapioca completa", "Tapioca com c�co, queijo e manteiga", "3,50");
...
//		assertEquals(
//				"Dona In�s - dines@gmail.com - 83 9999-5050 | Josenilda - nilda@computacao.ufcg.edu.br - 83 98736-5050 | Ron Weasley - rweasley@splab.ufcg.edu.br - 83 99936-5050",
...
//				controller.editarFornecedor("Dona In�s", "donaines@gmail.com", "3332.2222"));
//	}
//
//	@Test
...
//		assertEquals(
//				"Dona In�s - Bolo - Bolo de chocolate - R$3,00 | "
//						+ "Dona In�s - Tapioca completa - Tapioca com c�co, queijo e manteiga - R$3,50 | "
//						+ "Dona In�s - Tapioca simples - Tapioca com manteiga - R$3,00",
//				controller.listarProdutosDeUmFornecedor("Dona In�s"));
//	}
//
//	@Test
...
//		assertEquals("Dona In�s - Bolo - Bolo de chocolate - R$3,00 | "
//				+ "Dona In�s - Tapioca completa - Tapioca com c�co, queijo e manteiga - R$3,50 | "
//				+ "Dona In�s - Tapioca simples - Tapioca com manteiga - R$3,00 | "
//				+ "Josenilda - Buchada - Buchada de Bode - R$10,00 | "
//				+ "Josenilda - Mousse - Mousse de Lim�o - R$4,00 | "
