...
public class Agenda {
	...
	public Agenda() {
		// Este construtor não constrói nada, apenas inicia a Classe;		
	}
	...
	public String exibirContato(int posicao) {
		if (contatos[posicao - 1] == null) 
			throw new NoSuchElementException("NÃO EXISTE CONTATO NESTA POSIÇÃO!!");
		if (posicao > contatos.length || posicao < 1)
			throw new IndexOutOfBoundsException("POSIÇÃO INVÁLIDA!!");
	...
	public String listarContatos() {
		...
		if (contatosListados.trim().equals(""))
			throw new IllegalArgumentException("NÃO EXISTE CONTATOS CADASTRADOS!!");
